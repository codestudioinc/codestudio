  ...
  <div className="py-32 md:py-48 lg:py-60 relative overflow-x-clip">
   ...
   <div className="container">
    <div className="flex flex-col items-center">
     <Image
      ...
      alt="Personal peeking from behind laptop"
     />
    ...
    <div className="max-w-lg mx-auto">
     ...
     <p className="mt-4 text-center text-white/60 md:text-lg">
      We specialize in transforming designs into functional, high-performing web
   ...
   <a
    ...
    className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg 
                   ...
                   hover:shadow-[0_0_20px_rgba(34,197,94,0.8)] z-50 whatsapp-float"
   >
